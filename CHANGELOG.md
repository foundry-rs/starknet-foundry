...
- `generate_random_felt()` for generating (pseudo) random felt value. [Read more here](https://foundry-rs.github.io/starknet-foundry/appendix/cheatcodes/generate_random_felt.html).
