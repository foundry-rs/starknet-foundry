...
- `sncast multicall` allows to pass calls directly as CLI arguments. Read more [here](https://foundry-rs.github.io/starknet-foundry/appendix/sncast/multicall/run.md#multicall-with-cli-arguments)
