...
- Added new `snforge clean` command: Introduced a flexible snforge clean command to manage and remove files generated by snforge. This command supports cleaning the following components: coverage, profile, cache, trace, all
