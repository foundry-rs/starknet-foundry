...
- `snforge clean` command - used to manage and remove files generated by snforge. This command supports cleaning the following components: coverage, profile, cache, trace, all
