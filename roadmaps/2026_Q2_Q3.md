...
- [ ] Aliases for contracts in `snfoundry.toml` that can be used in commands instead of contract addresses (_size: 3_) (https://github.com/foundry-rs/starknet-foundry/issues/2240)
