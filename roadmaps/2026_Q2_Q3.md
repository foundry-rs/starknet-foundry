...
- [ ] 🏗️ Cache compiled Casm to improve performance (_size: 4_) (https://github.com/foundry-rs/starknet-foundry/issues/3832)
- [X] Typesafe declare by module path (_size: 4_) (https://github.com/foundry-rs/starknet-foundry/issues/1531)
- [X] Enable declaring contracts by path in tests (_size: 3_) (https://github.com/foundry-rs/starknet-foundry/issues/3266)
- [X] Add support for backtrace on test level (_size: 3_) (https://github.com/foundry-rs/starknet-foundry/issues/3610)
...
- [ ] 🏗️ New account interface with better security regarding private keys storage (_size: 5_) (https://github.com/foundry-rs/starknet-foundry/issues/3994)
...
- [X] Aliases for contracts in `snfoundry.toml` that can be used in commands instead of contract addresses (_size: 3_) (https://github.com/foundry-rs/starknet-foundry/issues/2240)
- [ ] Allow to set all flags values in `snfoundry.toml` (_size: 2_) (https://github.com/foundry-rs/starknet-foundry/issues/3105)
- [X] Option to run `balance` command for all contracts, not only accounts (_size: 1_) (https://github.com/foundry-rs/starknet-foundry/issues/3839)
