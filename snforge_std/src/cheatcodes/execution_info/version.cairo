...
/// - `target` - instance of `ContractAddress` specifying which contracts to cheat_version
...
fn start_cheat_version(target: ContractAddress, version: felt252) {
    cheat_version(target, version, CheatSpan::Indefinite);
}
