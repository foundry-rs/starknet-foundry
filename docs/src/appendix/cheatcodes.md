...
- [`cheat_transaction_version`](cheatcodes/version#cheat_transaction_version) - changes the transaction version for contracts, for a number of calls
- [`cheat_transaction_version_global`](cheatcodes/version#cheat_transaction_version_global) - changes the transaction version for all contracts
- [`start_cheat_transaction_version`](cheatcodes/version#start_cheat_transaction_version) - changes the transaction version for contracts
- [`stop_cheat_transaction_version`](cheatcodes/version#stop_cheat_transaction_version) - cancels the `cheat_transaction_version` / `start_cheat_transaction_version` for contracts
- [`stop_cheat_transaction_version_global`](cheatcodes/version#stop_cheat_transaction_version_global) - cancels the `cheat_transaction_version_global`
