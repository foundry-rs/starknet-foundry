# `declare-file`
Send a declare transaction of Cairo contract to Starknet from a compiled Sierra contract class file.

## Required Common Arguments — Passed By CLI or Specified in `snfoundry.toml`

* [`account`](./common.md#--account--a-account_name)

## `--sierra-file, -s <SIERRA_FILE>`
Required.

Path to the compiled Sierra file (e.g. `target/dev/MyContract_MyContract.contract_class.json`).
