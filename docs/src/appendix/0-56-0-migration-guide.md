...
> The deprecated `snforge_std_deprecated` package and `snforge_scarb_plugin_deprecated` plugin will no longer be supported, and no new versions of these will be published.
