...
> 💡 **Tip: Speed up with caching**
>
> The first run compiles all dependencies, which takes several minutes. To cache the Cargo registry, asdf toolchain (Scarb, devnet, universal-sierra-compiler) and `~/.local` across runs, add:
>
> ```
