...
You can either use it directly without deploying a contract or use it to modify the state of an existing contract.
...
In the examples below, we will use the following contract:

```rust
{{#include ../../listings/testing_contract_internals/src/contract.cairo}}
```

#### Testing state without a deployed contract

```rust
{{#include ../../listings/testing_contract_internals/tests/basic_contract_state_for_testing.cairo}}
```
