...
pub trait IDataTransformer<TContractState> {
    ...
    fn complex_fn(ref self: TContractState, arr: Array<Array<felt252>>, one: u8, two: i16, three: ByteArray, four: (felt252, u32), five: bool, six: u256);
...
mod DataTransformer {
    ...
    impl DataTransformerImpl of super::IDataTransformer<ContractState> {
        ...
        fn complex_fn(ref self: ContractState, arr: Array<Array<felt252>>, one: u8, two: i16, three: ByteArray, four: (felt252, u32), five: bool, six: u256) {}
