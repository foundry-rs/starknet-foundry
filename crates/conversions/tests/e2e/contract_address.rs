...
mod tests_contract_address {
    ...
    use crate::helpers::hex::hex_to_stark_felt;
    ...
    fn test_contract_address_conversions_limit() {
        ...
        let mut contract_address = ContractAddress(PatriciaKey::try_from(hex_to_stark_felt(max_value)).unwrap());

        assert_eq!(contract_address, contract_address.to_class_hash().to_contract_address());
        assert_eq!(contract_address, contract_address.to_felt252().to_contract_address());
        assert_eq!(contract_address, contract_address.to_field_element().to_contract_address());
        assert_eq!(contract_address, contract_address.to_nonce().to_contract_address());
        assert_eq!(contract_address, contract_address.to_stark_felt().to_contract_address());
        assert_eq!(contract_address, contract_address.to_stark_hash().to_contract_address());
        ...
        contract_address = ContractAddress(PatriciaKey::try_from(hex_to_stark_felt(max_value)).unwrap());

        assert_eq!(contract_address, contract_address.to_short_string().to_contract_address());
    }
    ...
    fn test_contract_address_conversions_out_of_range() {
        ...
        let contract_address = ContractAddress(PatriciaKey::try_from(hex_to_stark_felt(max_value)).unwrap());
