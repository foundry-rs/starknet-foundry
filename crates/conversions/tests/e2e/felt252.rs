...
mod tests_felt252 {
    ...
    use crate::helpers::hex::hex_to_felt252;
    ...
    fn test_felt252_conversions_limit() {
        ...
        let mut felt252 = hex_to_felt252(max_value);
        ...
        felt252 = hex_to_felt252(max_value);
    ...
    fn test_felt252_conversions_out_of_range() {
        ...
        let mut felt252: Felt252 = hex_to_felt252(max_value);
