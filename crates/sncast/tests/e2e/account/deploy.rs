...
#[test_case(&OZ_CLASS_HASH.into_hex_string(), "oz", "oz_cairo_1_class_hash"; "oz_cairo_1_class_hash")]
...
async fn test_account_deploy_error_when_public_key_not_present() {
    ...
    snapbox.stderr_eq(indoc!(
        "
        Command: account deploy
        Error: invalid schema of field accounts.alpha-sepolia.my_account in the accounts file
