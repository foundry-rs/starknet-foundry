...
#[cfg(test)]
mod tests {
    use crate::response::deploy::{DeployResponse, StandardDeployTransactionResponse};
    use crate::{
        Network,
    ...
    const MAINNET_RESPONSE: DeployResponse = DeployResponse::Standard(
    ...
    const SEPOLIA_RESPONSE: DeployResponse = DeployResponse::Standard(
        StandardDeployResponse::Transaction(StandardDeployTransactionResponse {
            contract_address: PaddedFelt(felt!(
