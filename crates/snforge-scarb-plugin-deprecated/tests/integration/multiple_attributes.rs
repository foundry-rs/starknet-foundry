...
use indoc::formatdoc;
use snforge_scarb_plugin_deprecated::attributes::fuzzer::wrapper::fuzzer_wrapper;
use snforge_scarb_plugin_deprecated::attributes::fuzzer::{fuzzer, fuzzer_config};
use snforge_scarb_plugin_deprecated::attributes::{
    available_gas::available_gas, fork::fork, test::test,
};
        ...
        r#"
            ...
            fn empty_fn_return_wrapper() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::ForkConfig::Named("test")
                        .serialize(ref data);
        ...
        r"
            ...
            fn empty_fn_return_wrapper(f: felt252) {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::FuzzerConfig {
        ...
        r"
            ...
            fn empty_fn_return_wrapper() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    empty_fn_return_wrapper_actual_body(snforge_std_deprecated::fuzzable::Fuzzable::blank());

                    return;
                }
                let f: felt252 = snforge_std_deprecated::fuzzable::Fuzzable::generate();
                snforge_std_deprecated::_internals::save_fuzzer_arg(@f);
