...
use indoc::formatdoc;
use snforge_scarb_plugin_deprecated::attributes::disable_predeployed_contracts::disable_predeployed_contracts;
        ...
        "
            fn empty_fn() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::PredeployedContractsConfig {
                        is_disabled: true
                    }
                    .serialize(ref data);
