...
use indoc::formatdoc;
use snforge_scarb_plugin_deprecated::attributes::should_panic::should_panic;
        ...
        r"
            fn empty_fn() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::ShouldPanicConfig {
                        expected: snforge_std_deprecated::_internals::config_types::Expected::Any
                    }
                    .serialize(ref data);
        ...
        r#"
            fn empty_fn() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::ShouldPanicConfig {
                        expected: snforge_std_deprecated::_internals::config_types::Expected::ByteArray("panic data")
                    }
                    .serialize(ref data);
        ...
        r#"
            fn empty_fn() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::ShouldPanicConfig {
                        expected: snforge_std_deprecated::_internals::config_types::Expected::ByteArray("can\"t \0 null byte")
                    }
                    .serialize(ref data);
        ...
        r"
            fn empty_fn() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::ShouldPanicConfig {
                        expected: snforge_std_deprecated::_internals::config_types::Expected::ShortString('panic data')
                    }
                    .serialize(ref data);
        ...
        r"
            fn empty_fn() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::ShouldPanicConfig {
                        expected: snforge_std_deprecated::_internals::config_types::Expected::ShortString('can\'t')
                    }
                    .serialize(ref data);
        ...
        "
            fn empty_fn() {
                if snforge_std_deprecated::_internals::is_config_run() {
                    ...
                    snforge_std_deprecated::_internals::config_types::ShouldPanicConfig {
                        expected: snforge_std_deprecated::_internals::config_types::Expected::Array(array!['panic data',' or not',])
                    }
                    .serialize(ref data);
