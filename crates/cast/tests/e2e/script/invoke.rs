...
async fn test_max_fee_too_low() {
    ...
    let snapbox = Command::new(cargo_bin!("sncast"))
        .current_dir(SCRIPTS_DIR.to_owned() + "/invoke/max_fee_too_low")
        .args(args);
...
async fn test_contract_does_not_exist() {
    ...
    let snapbox = Command::new(cargo_bin!("sncast"))
        .current_dir(SCRIPTS_DIR.to_owned() + "/invoke/contract_does_not_exist")
        .args(args);
    snapbox.assert().success().stderr_matches(indoc! {r"
        ...
        command: script
...
fn test_wrong_function_name() {
    ...
    let snapbox = Command::new(cargo_bin!("sncast"))
        .current_dir(SCRIPTS_DIR.to_owned() + "/invoke/wrong_function_name")
        .args(args);
    snapbox.assert().success().stderr_matches(indoc! {r"
        ...
        command: script
...
fn test_wrong_calldata() {
    ...
    let snapbox = Command::new(cargo_bin!("sncast"))
        .current_dir(SCRIPTS_DIR.to_owned() + "/invoke/wrong_calldata")
        .args(args);
    snapbox.assert().success().stderr_matches(indoc! {r"
        ...
        command: script
