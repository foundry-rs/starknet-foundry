...
//     casm: &str,
// ) -> bool {
//     declare_token(cached_state, class_hash, casm);
//     deploy_token(
//         syscall_handler,
//         cheatnet_state,
//         class_hash,
...
// pub fn declare_and_deploy_token_strk(
//     cached_state: &mut CachedState<ExtendedStateReader>,
//     syscall_handler: &mut SyscallHintProcessor,
//     cheatnet_state: &mut CheatnetState,
// ) -> bool {
//     let class_hash = ClassHash::try_from_hex_str(STRK_CLASS_HASH)
//         .unwrap()
//         .try_into()
//         .unwrap();
//     let contract_address = ContractAddress::try_from_hex_str(STRK_CONTRACT_ADDRESS).unwrap();
//     declare_and_deploy_token(
//         cached_state,
//         syscall_handler,
//         cheatnet_state,
//         class_hash,
