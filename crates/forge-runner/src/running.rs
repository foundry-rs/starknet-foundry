...
use crate::forge_config::RuntimeConfig;
use crate::gas::calculate_used_gas;
use crate::test_case_summary::{Single, TestCaseSummary};
use crate::{TestCaseRunnable, CACHE_DIR};
...
pub fn run_test_case(
    ...
    let forge_extension = ForgeExtension {
        environment_variables: &context_data.runtime_data.environment_variables,
        contracts_data: &context_data.runtime_data.contracts_data,
    };
