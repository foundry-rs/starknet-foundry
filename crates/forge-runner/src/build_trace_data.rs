...
pub fn build_profiler_execution_resources(
    ...
    // TODO(#3744): This logic can be removed, as the profiler no longer uses these resources directly.
    // However, they are still used to determine which resource to track, so they cannot be set to zero.
