...
fn warp_simple() {
    ...
    let selector = get_felt_selector_from_name("get_block_timestamp");
...
fn warp_with_other_syscall() {
    ...
    let selector = get_felt_selector_from_name("get_block_timestamp_and_emit_event");
...
fn warp_in_constructor() {
    ...
    let selector = get_felt_selector_from_name("get_stored_block_timestamp");
...
fn warp_proxy() {
    ...
    let proxy_selector = get_felt_selector_from_name("get_warp_checkers_block_timestamp");
...
fn warp_library_call() {
    ...
    let lib_call_selector = get_felt_selector_from_name("get_block_timestamp_with_lib_call");
    let output = call_contract(
        &lib_call_address,
        &lib_call_selector,
