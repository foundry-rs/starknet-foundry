...
fn warp_simple() {
    ...
    let contract_address = deploy_contract(&mut blockifier_state, &mut cheatnet_state, "WarpChecker", &[]);
...
fn warp_proxy() {
    ...
    let proxy_address = deploy_contract(&mut blockifier_state, &mut cheatnet_state, "WarpCheckerProxy", &[]);
...
fn warp_library_call() {
    ...
    let lib_call_address = deploy_contract(&mut blockifier_state, &mut cheatnet_state, "WarpCheckerLibCall", &[]);
