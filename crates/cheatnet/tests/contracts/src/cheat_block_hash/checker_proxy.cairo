...
trait ICheatBlockHashCheckerProxy<TContractState> {
    fn get_cheated_block_hash(self: @TContractState, address: ContractAddress, block_number: u64) -> felt252;
    fn get_block_hash(self: @TContractState, block_number: u64) -> felt252;
    fn call_proxy(self: @TContractState, address: ContractAddress, block_number: u64) -> (felt252, felt252);
}
...
mod CheatBlockHashCheckerProxy {
    ...
    impl ICheatBlockHashCheckerProxy of super::ICheatBlockHashCheckerProxy<ContractState> {
        fn get_cheated_block_hash(self: @ContractState, address: ContractAddress, block_number: u64) -> felt252 {
        ...
        fn call_proxy(self: @ContractState, address: ContractAddress, block_number: u64) -> (felt252, felt252) {
