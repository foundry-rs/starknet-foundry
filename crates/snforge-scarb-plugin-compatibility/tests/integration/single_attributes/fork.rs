...
use indoc::formatdoc;
use snforge_scarb_plugin_compatibility::attributes::fork::fork;
        ...
        r#"
            fn empty_fn() {
                if snforge_std_compatibility::_internals::is_config_run() {
                    ...
                    snforge_std_compatibility::_internals::config_types::ForkConfig::Inline(
                        snforge_std_compatibility::_internals::config_types::InlineForkConfig {
                            url: "http://example.com/",
                            block: snforge_std_compatibility::_internals::config_types::BlockId::BlockNumber(0x17)
                        }
                    )
                    .serialize(ref data);
        ...
        r#"
            fn empty_fn() {
                if snforge_std_compatibility::_internals::is_config_run() {
                    ...
                    snforge_std_compatibility::_internals::config_types::ForkConfig::Overridden(
                        snforge_std_compatibility::_internals::config_types::OverriddenForkConfig {
                            block: snforge_std_compatibility::_internals::config_types::BlockId::BlockNumber(0x17),
                            name: "MAINNET"
                        }
                     )
