...
use indoc::formatdoc;
use snforge_scarb_plugin_compatibility::attributes::fuzzer::wrapper::fuzzer_wrapper;
use snforge_scarb_plugin_compatibility::attributes::fuzzer::{fuzzer, fuzzer_config};
use snforge_scarb_plugin_compatibility::attributes::{available_gas::available_gas, fork::fork, test::test};
        ...
        "
            ...
            fn empty_fn_return_wrapper() {
                if snforge_std_compatibility::_internals::is_config_run() {
                    ...
                    snforge_std_compatibility::_internals::config_types::AvailableGasConfig::MaxResourceBounds(
                        snforge_std_compatibility::_internals::config_types::AvailableResourceBoundsConfig {
                            l1_gas: 0x1,
                            l1_data_gas: 0x2,
                            l2_gas: 0x3
                        }
        ...
        r#"
            ...
            fn empty_fn_return_wrapper() {
                if snforge_std_compatibility::_internals::is_config_run() {
                    ...
                    snforge_std_compatibility::_internals::config_types::ForkConfig::Named("test")
                        .serialize(ref data);
        ...
        r"
            ...
            fn empty_fn_return_wrapper(f: felt252) {
                if snforge_std_compatibility::_internals::is_config_run() {
                    ...
                    snforge_std_compatibility::_internals::config_types::FuzzerConfig {
        ...
        r"
            ...
            fn empty_fn_return_wrapper() {
                if snforge_std_compatibility::_internals::is_config_run() {
                    ...
                    empty_fn_return_wrapper_actual_body(snforge_std_compatibility::fuzzable::Fuzzable::blank());

                    return;
                }
                let f: felt252 = snforge_std_compatibility::fuzzable::Fuzzable::generate();
                snforge_std_compatibility::_internals::save_fuzzer_arg(@f);
