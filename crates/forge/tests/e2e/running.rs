...
fn with_include_ignored_flag() {
    ...
    assert_stdout_contains(
        ...
        [PASS] simple_package_integrationtest::without_prefix::five [..]
        Tests: 10 passed, 3 failed, 0 skipped, 0 ignored, other filtered out
...
fn with_rerun_failed_flag() {
    ...
    assert_stdout_contains(
        ...
        Tests: 0 passed, 2 failed, 0 skipped, 0 ignored, other filtered out
...
fn incompatible_snforge_std_version_warning() {
    ...
    assert_stdout_contains(
        ...
        Tests: 2 passed, 2 failed, 0 skipped, 0 ignored, other filtered out
