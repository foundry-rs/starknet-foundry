...
fn root_workspace_without_arguments() {
    ...
    assert_stdout_contains(
        ...
        Tests: 1 passed, 2 failed, 0 skipped, 0 ignored, other filtered out
...
fn root_workspace_specific_package() {
    ...
    assert_stdout_contains(
        ...
        Tests: 5 passed, 0 failed, 0 skipped, 0 ignored, other filtered out
        "},
    );
}
...
fn root_workspace_specific_package2() {
    ...
    assert_stdout_contains(
        ...
        Tests: 5 passed, 1 failed, 0 skipped, 0 ignored, other filtered out
