...
fn fuzzing() {
    ...
    assert_stdout_contains(
        ...
        Tests: 12 passed, 1 failed, 0 ignored, 14 filtered out
        Fuzzer seed: [..]
...
fn fuzzing_multiple_attributes() {
    ...
    assert_stdout_contains(
        ...
        Tests: 3 passed, 0 failed, 1 ignored, 23 filtered out
        "},
    );
}
...
fn generate_arg_cheatcode() {
    ...
    assert_stdout_contains(
        ...
        Tests: 1 passed, 1 failed, 0 ignored, 25 filtered out
        "#},
    );
}
...
fn fuzz_generic_struct() {
    ...
    assert_stdout_contains(
        ...
        Tests: 1 passed, 0 failed, 0 ignored, 26 filtered out
        "},
    );
}
...
fn fuzz_derive_fuzzable() {
    ...
    let output = test_runner(&temp).arg("derive_fuzzable").assert().code(1);
    ...
    assert_stdout_contains(
        ...
        Collected 7 test(s) from fuzzing package
        Running 7 test(s) from tests/
        [PASS] fuzzing_integrationtest::derive_fuzzable::test_derived_struct ([..])
        [PASS] fuzzing_integrationtest::derive_fuzzable::test_derived_enum ([..])
        [PASS] fuzzing_integrationtest::derive_fuzzable::test_struct_with_multiple_field_types ([..])
        [PASS] fuzzing_integrationtest::derive_fuzzable::test_data_enum ([..])
        [PASS] fuzzing_integrationtest::derive_fuzzable::test_nested_derived_structs ([..])
        [PASS] fuzzing_integrationtest::derive_fuzzable::test_struct_with_all_primitives ([..])
        [FAIL] fuzzing_integrationtest::derive_fuzzable::test_failing_derived_enum (runs: [..], arguments: [[..]])

        Failure data:
            [..]

        Tests: 6 passed, 1 failed, 0 ignored, 25 filtered out
        Fuzzer seed: [..]

        Failures:
            fuzzing_integrationtest::derive_fuzzable::test_failing_derived_enum
        "},
    );
}
