...
fn test_backtrace() {
    ...
    assert_stdout_contains(
        ...
        indoc! {
           "
            [WARNING] Scarb version should be 2.12 or higher and `Scarb.toml` should have the following Cairo compiler configuration to run backtrace:
            ...
            To get accurate backtrace results.
