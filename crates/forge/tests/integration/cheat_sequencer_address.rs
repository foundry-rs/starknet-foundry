    ...
    let test = test_case!(
        indoc!(
            ...
            fn test_stop_cheat_sequencer_address() {
                let contract = declare("CheatSequencerAddressChecker").unwrap().success_contract_class();
    ...
    let test = test_case!(
        indoc!(
            ...
            fn deploy_cheat_sequencer_address_checker() -> ICheatSequencerAddressCheckerDispatcher {
                let (contract_address, _) = declare("CheatSequencerAddressChecker").unwrap().success_contract_class().deploy(@ArrayTrait::new()).unwrap();
