...
fn simple_syscalls() {
    let test = test_case!(
        ...
        fn simple_syscalls() {
            ...
            let contract_cheat_block_number = declare("CheatBlockNumberChecker").unwrap().success_contract_class();
            ...
            let contract_cheat_block_timestamp = declare("CheatBlockTimestampChecker").unwrap().success_contract_class();
            ...
            let contract_cheat_sequencer_address = declare("CheatSequencerAddressChecker").unwrap().success_contract_class();
...
fn get_block_hash_syscall_in_dispatcher() {
    let test = test_case!(
        ...
        #[test]
        fn get_block_hash_syscall_in_dispatcher() {
            let block_hash_checker = declare("BlockHashChecker").unwrap().success_contract_class();
...
fn library_calls() {
    let test = test_case!(
        ...
        #[test]
        fn library_calls() {
            let class_hash = declare("LibraryContract").unwrap().success_contract_class().class_hash.clone();
...
fn cant_call_test_contract() {
    let test = test_case!(
        ...
        #[test]
        fn cant_call_test_contract() {
            let contract = declare("CallsBack").unwrap().success_contract_class();
            let (contract_address, _) = contract.deploy(@ArrayTrait::new()).unwrap();
...
fn caller_address_in_called_contract() {
    let test = test_case!(
        ...
        #[test]
        fn caller_address_in_called_contract() {
            let cheat_caller_address_checker = declare("CheatCallerAddressChecker").unwrap().success_contract_class();
            ...
            let constructor_cheat_caller_address_checker = declare("ConstructorCheatCallerAddressChecker").unwrap().success_contract_class();
