...
// #[test]
// fn elect_cairo0_contract() {
//     let test = test_case!(formatdoc!(
//         r#"
//             use starknet::{{class_hash::Felt252TryIntoClassHash, SyscallResultTrait}};
//             use snforge_std::{{start_elect, stop_elect, test_address}};
...
//                 start_elect(test_address(), 123);

//                 let elected_block_timestamp = starknet::library_call_syscall(
//                     CAIRO0_CLASS_HASH.try_into().unwrap(),
//                     LIB_CALL_SELECTOR,
//                     array![].span(),
//                 ).unwrap_syscall()[0];
...
//                 let unelected_block_timestamp = starknet::library_call_syscall(
//                     CAIRO0_CLASS_HASH.try_into().unwrap(),
//                     LIB_CALL_SELECTOR,
//                     array![].span(),
//                 ).unwrap_syscall()[0];

//                 assert(*elected_block_timestamp == 123, 'start_elect does not work');
//                 assert(unelected_block_timestamp == block_timestamp, 'stop_elect does not work');
//             }}
//         "#,
//         CHEATNET_RPC_URL,
//     )
