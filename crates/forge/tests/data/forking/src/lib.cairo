...
mod tests {
    ...
    #[test]
    #[fork(url: "http://188.34.188.184:9545/rpc/v0.5", block_id: BlockId::Number(313388))]
    fn test_fork_simple() {
    ...
    #[test]
    #[fork(url: "http://188.34.188.184:9545/rpc/v0.5", block_id: BlockId::Number(0x4c82c))]
    ...
    #[test]
    #[fork(url: "http://188.34.188.184:9545/rpc/v0.5", block_id: BlockId::Tag(Latest))]
