...
const MINIMAL_RECOMMENDED_SCARB_VERSION: Version = Version::new(2, 18, 0);
const MAXIMAL_RECOMMENDED_SCARB_VERSION: Version = Version::new(2, 20, 1);
const MINIMAL_USC_VERSION: Version = Version::new(2, 10, 0);
