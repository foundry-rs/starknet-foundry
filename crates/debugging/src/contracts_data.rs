...
impl ContractsData {
    /// Creates a new instance of [`ContractsData`] from a similar structure from `cheatnet`: [`CheatnetContractsData`].
    #[must_use]
    pub fn new(cheatnet_contracts_data: &CheatnetContractsData) -> Self {
